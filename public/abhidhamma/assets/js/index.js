(function ($, undefined) {
    ...
    $(document).on("pagebeforechange", function (e, f) {
        ...
        if (typeof hash !== "undefined" &&
            ...
            // hack to fix when click on "Top" link or Quick Links, the html part filename is not there
            // so next and prev page links won't work
            var startsWithHash = hash.indexOf('#') == 0;
            if (startsWithHash) {
...
//                        id = text.replace(/[^\.a-z0-9:_-]+/gi, "");
                        // myanmar chars range \u1000-\u109F
                        id = text.replace(/[^\.a-z0-9\u1000-\u109F:_-]+/gi, "");
                        $(this).attr("id", id);
                    } else {
                        id = $(this).attr("id");
                    }
